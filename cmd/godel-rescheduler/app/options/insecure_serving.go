...
func (o *CombinedInsecureServingOptions) applyTo(c *reschedulerappconfig.Config, componentConfig *godelreschedulerconfig.GodelReschedulerConfiguration) error {
	...
	if o.Metrics != nil && (c.ReschedulerConfig.MetricsBindAddress != c.ReschedulerConfig.HealthzBindAddress || o.Healthz == nil) {
...
// ApplyTo applies the insecure serving options to the given scheduler app configuration, are updates the componentConfig.
func (o *CombinedInsecureServingOptions) ApplyTo(c *reschedulerappconfig.Config, componentConfig *godelreschedulerconfig.GodelReschedulerConfiguration) error {
	if o == nil {
...
func (o *CombinedInsecureServingOptions) ApplyToFromLoadedConfig(c *reschedulerappconfig.Config, componentConfig *godelreschedulerconfig.GodelReschedulerConfiguration) error {
	if o == nil {
		return nil
	}
