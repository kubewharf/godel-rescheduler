...
var (
	_ api.DetectorPlugin          = &Protection{}
	_ api.AlgorithmPlugin         = &Protection{}
	_ api.PolicyStoreSyncerPlugin = &Protection{}
)
...
func (p *Protection) Name() string {
	return Name
}

func (p *Protection) Detect(_ context.Context) (api.DetectorResult, error) {
	return api.DetectorResult{}, nil
}

func (p *Protection) SyncPolicyStore(ctx context.Context, snapshot *reschedulercache.ReschedulingSnapshot) policies.PolicyStore {
	return newProtectionStore()
}

func (p *Protection) Reschedule(ctx context.Context, detectRes api.DetectorResult) (api.RescheduleResult, error) {
