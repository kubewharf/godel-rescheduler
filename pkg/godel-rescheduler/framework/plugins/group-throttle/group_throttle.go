...
var (
	_ api.DetectorPlugin          = &GroupThrottle{}
	_ api.AlgorithmPlugin         = &GroupThrottle{}
	_ api.PolicyStoreSyncerPlugin = &GroupThrottle{}
)
...
func New(plArgs apiruntime.Object, rfh framework.ReschedulerFrameworkHandle) (godel_framework.Plugin, error) {
	...
	if args, ok := plArgs.(*config.GroupThrottleArgs); !ok || args == nil {
...
func (t *GroupThrottle) Name() string {
	return Name
}

func (t *GroupThrottle) Detect(_ context.Context) (api.DetectorResult, error) {
	return api.DetectorResult{}, nil
}

func (t *GroupThrottle) SyncPolicyStore(ctx context.Context, snapshot *reschedulercache.ReschedulingSnapshot) policies.PolicyStore {
	return newThrottleStore(snapshot, t.throttleItems)
}

func (t *GroupThrottle) Reschedule(ctx context.Context, detectRes api.DetectorResult) (api.RescheduleResult, error) {
